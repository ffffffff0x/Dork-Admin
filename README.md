...
**4**
- 22 - Bilibili网站后台工程源代码被上传至[Github](https://github.com/openbilibili)(ikun大胜利?)
```
大致时间：2019年4月22
事件经过：大家好，我是练习时长两年半的唱跳rap篮球music~
```

- 25 - 未经授权的访问者访问了Docker Hub的数据库，可能导致泄露19万用户敏感数据
```
...
**6**
- A站官方宣传近千万条用户数据外泄(把用户数报高一点好让快手爸爸多给钱?)
```
...
# 2017
**8**
- Aadhaar印度国家身份认证系统11亿用户数据泄露(印度国家身份认证系统将公民信息卖给了乡村企业家?)
```
泄露目标：印度公民
